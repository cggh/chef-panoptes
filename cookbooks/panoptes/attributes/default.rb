...
default['panoptes']['database_data_dir'] = "/mnt/storage/mysql"
default['panoptes']['database_tmp_dir'] = "/mnt/storage/tmpmysql"
...
default["panoptes"]["source_dir"] = "/data/panoptes/source"
default["panoptes"]["base_dir"] = "/data/panoptes/base"
